...
const SearchPage = () => {
  ...
  const handleSearch = (query: string) => {
    ...
    const filtered = allVeterans.filter(veteran =>
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow bg-gray-50 py-12">
        <div className="container mx-auto px-4">
          <h1 className="text-3xl font-bold mb-8 text-center text-victory-dark-blue">Поиск ветеранов</h1>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                ...
                <select className="border border-gray-300 rounded-md py-1 pl-2 pr-8 focus:outline-none focus:ring-2 focus:ring-victory-dark-red text-sm">
          ...
          {searchResults.length > 0 ? (
            ...
            <div className="text-center py-10">
              <p className="text-gray-700 text-lg mb-4">По вашему запросу ничего не найдено</p>
              <button 
